  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-12" id="content">
        ...
        <p>If you already have an account with us, please login at the <a href="<?= BASE_URL . 'login.php' ?>">login page</a>.</p>
        <form class="form-horizontal form-register" enctype="multipart/form-data" method="post" action="" onsubmit="return validate()">
          <fieldset id="account">
            ...
            <div class="form-group required">
              ...
              <div class="col-sm-7">
                <input type="tel" class="form-control" id="input-telephone" placeholder="Telephone" value="" name="phone" required>
              </div>
            </div>
          ...
          <div class="buttons">
            <p><input type="checkbox" name="agree" id="agree"> I have read and agree to the <a class="agree" href="#"><b>Privacy Policy</b></a> </p>
            <br>
